...
#   2. Commit message contains 'JAVA_8_OVERRIDE'  (per-commit override)
...
if git log -1 --format=%B 2>/dev/null | grep -q 'JAVA_8_OVERRIDE'; then
  echo "JAVA_8_OVERRIDE found in commit message - using JDK 8"
