...
public class MetricWrappedKuduEnumerator implements SplitEnumerator<KuduSourceSplit,
  ...
  public void start() {
    ...
    context.metricGroup().gauge("pendingSplits", (Gauge<Integer>) this::getPendingSplits);
    context.metricGroup().gauge("unassignedSplits", (Gauge<Integer>) this::getUnassignedSplits);
    delegate.start();
  }
