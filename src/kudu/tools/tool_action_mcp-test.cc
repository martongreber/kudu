...
// this doubles as the assertion that the protocol line is valid JSON.
...
// Bad path: a GATED tool is absent from the registry without --allow-writes, so
// calling it is rejected server-side as an unknown tool.
